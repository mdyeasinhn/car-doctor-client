    ...
    return (
        <div>
            ...
            <div className="bg-[#F3F3F3] rounded-lg">
                <form onSubmit={handleBookService} className="mb-6 p-20" >
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" name='massage' placeholder="Your Massage" className="input input-bordered h-[250px]" required />
                    </div>
                    <div className="mt-6">
